...
argument-hint: "[area: angularjs | angular-nx | react-mfe | spring | oracle | alloydb | search-cache | all]"
...
1. Apply detectors from the relevant reference(s):
   `detectors-angularjs.md`, `detectors-angular-nx.md`, `detectors-react-mfe.md`,
   `detectors-spring.md`, `detectors-oracle.md`, `detectors-alloydb.md`,
   `detectors-search-cache.md`. Use only the ones for stacks present in the estate.
